...
public class MainController implements ActionListener {
    ...
    private OptimisationAnalysis2 optimizer;
    ...
    public MainController(ViewMain mainView, WordAnalysis wordAnalysis) {
        ...
        this.optimizer = new OptimisationAnalysis2();
        ...
        this.mainView.getTableTriplo().setModel(new DefaultTableModel(new String[]{"renglon", "objeto", "fuente", "operador"}, 0));
        this.mainView.getTableAsm().setModel(new DefaultTableModel(new String[]{"etiqueta", "memonico", "guardado", "fuente"}, 0));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == mainView.getAnalyze()) {
            ...
            String codeOptimizer = optimizer.compileOptimizer(this.mainView.textArea.getText());
            mainView.getTextAreaOptimizer().setText(codeOptimizer);
            this.wordAnalysis.compile(codeOptimizer);
            // this.compiler.compile(codeOptimizer);
