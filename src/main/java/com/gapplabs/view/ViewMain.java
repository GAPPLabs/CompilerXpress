...
public class ViewMain extends javax.swing.JFrame {
  ...
  public AbstractButton[] getAllButtons() {
    AbstractButton componetsArray[] = {this.analyze, this.exit, this.open, this.reset, this.save, this.token};
  ...
  private void initComponents() {
    ...
    jPanel2Layout.setVerticalGroup(
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addComponent(scrollTextArea, javax.swing.GroupLayout.DEFAULT_SIZE, 358, Short.MAX_VALUE)
        .addContainerGap())
    );
